...
color:#fff;
  ...
  <div class="menu-bar">
    <ul>
      ...
      <li class= "active"><a href="aboutus"><i class="fa-solid fa-house"></i>ABOUT US</a></li>
      <li><a href="#"><i class="fa-solid fa-clone"></i>SERVICES</a>
          <div class="sub-menu">
            <ul>
              <li><a href="#">Imaging</a></li>
              <li><a href="#">Pathology</a></li>
              <li><a href="diagnostic">Diagnostic Imaging</a></li>
            </ul>
          </div>
      </li>
      <li><a href="doctors"><i class="fa-solid fa-stethoscope"></i>DOCTORS</a></li>
			...
			<div class="col">
				<div class="overflow-hidden mb-3">
					<h2 class="word-rotator slide font-weight-bold text-8 mb-0 appear-animation animated maskUp appear-animation-visible" data-appear-animation="maskUp" style="animation-delay: 100ms;">
						...
						<span class="word-rotator-words bg-danger" style="width: 150.75px;">
							<b class="is-visible">Healthy Life</b>
						</span>
					</h2>
				</div>
			</div>
		...
		<div class="row mb-2">
			<div class="col">
				<div class="overflow-hidden">
					<p class="lead mb-0 appear-animation animated maskUp appear-animation-visible" data-appear-animation="maskUp" data-appear-animation-delay="250" style="font-size: 18px;">
						<span class="alternative-font">Medi Aid Complex(Pvt.)Ltd.</span> is committed to render the possible standard service to the people of the country at an affordable cost. This will definitely reduce the burden of the government and will make the path of "Health for all".
					</p>
				</div>
			</div>
	</div>
		...
		<div class="container py-4">
			...
			<div class="row align-items-center">
				<div class="col-md-6 appear-animation animated fadeInLeftShorter appear-animation-visible" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1000" style="animation-delay: 1000ms;">
				    <img src="image/bg-img1.jpg" width="100%">
				</div>
				<div class="col-md-6">
					...
					<p class="appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1400" style="animation-delay: 1400ms; font-size: 17px">
          Medi Aid Complex(Pvt.)Ltd. <br> Facility Registry Government of People's Republic of Bangladesh Ministry of Health and Family Welfare
        , Permission / Approval /License Number HSM80940   <br>  Year of established: 1986<br> Type of Organization : Consultancy & Diagnostic 
      Center <br> Ownership: Non-Government (Private Commercial) <br> Organization Fucntion : Diagnostic Center  <br>Organization Level
    : National, Health Care Level: Primary <br>Located: 20 K.B. Fazlul Quader Road , Chattogram. <br>Phone Number : 01747169299</p>
				</div>
			</div>
</div>
		</div>
